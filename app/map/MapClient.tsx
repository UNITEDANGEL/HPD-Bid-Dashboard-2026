...
.job-drawer {
        ...
        .map-shell.full-map-mode .job-drawer.closed {
          ...
          .maturity-map-marker .map-signal-marker.marker-overview::after {
            bottom: -5px;
            width: 10px;
            height: 10px;
            border-width: 2px;
          ...
          .maturity-map-marker .map-signal-marker.marker-compact::after {
            bottom: -7px;
            width: 14px;
            height: 14px;
            border-width: 2px;
          ...
          .maturity-map-marker .map-signal-marker.marker-has-overdue {
            border-color: #ef4444 !important;
            background:
              linear-gradient(180deg, rgba(255, 255, 255, 0.99), rgba(255, 241, 242, 0.97)) !important;
            color: #0f172a !important;
            box-shadow:
              0 0 0 3px rgba(255, 255, 255, 0.95),
              0 0 0 7px rgba(239, 68, 68, 0.10),
              0 14px 30px rgba(127, 29, 29, 0.20) !important;
          }

          .maturity-map-marker .map-signal-marker.marker-has-overdue.marker-expanded::before,
          .maturity-map-marker .map-signal-marker.marker-has-overdue.marker-detailed::before {
            content: "";
            position: absolute;
            inset: -8px;
          ...
          .maturity-map-marker .map-signal-marker.marker-has-overdue.marker-overview {
            ...
            box-shadow:
              ...
              0 8px 18px rgba(127, 29, 29, 0.16) !important;
          }
          ...
          .maturity-map-marker .map-signal-marker.marker-has-overdue.marker-compact .signal-main {
            font-size: 21px !important;
          }
          ...
          .job-drawer.selected-focus .field-mission-jobline {
            padding: 16px !important;
            border-radius: 20px !important;
            background: rgba(248, 250, 252, 0.105) !important;
          }
          ...
          .job-drawer.selected-focus .field-mission-main small {
            display: none !important;
          }

          .job-drawer.selected-focus .field-mission-counter {
            min-height: 54px !important;
          }
          ...
          .job-drawer.selected-focus .field-mission-counter b {
            font-size: 20px !important;
          }

          .job-drawer.selected-focus .field-mission-primary {
          ...
          .job-drawer.selected-focus .field-mission-actions a,
          .job-drawer.selected-focus .field-mission-actions button {
            min-height: 44px !important;
            border-radius: 14px !important;
            padding: 6px !important;
            font-size: 11px !important;
          ...
          .site-procedure-scenarios .start-job-btn strong {
            font-size: 28px !important;
          }
          ...
          .site-procedure-scenarios .refused-job-btn {
            background: rgba(248, 113, 113, 0.23) !important;
            border-color: rgba(248, 113, 113, 0.44) !important;
          }
          ...
          /* JOB_CARD_ENTRY_FIT_2026 */
          .job-drawer.selected-focus {
            animation: jobCardEnter 190ms cubic-bezier(0.2, 0.8, 0.2, 1) both !important;
          ...
          .job-drawer.selected-focus .selected-card {
            ...
            padding: 10px !important;
            margin-top: 0 !important;
            animation: selectedCardEnter 210ms cubic-bezier(0.2, 0.8, 0.2, 1) both !important;
          }
          ...
          .job-drawer.selected-focus .appointment-hero.needs-appointment {
            background:
              linear-gradient(180deg, #ffffff, #eff6ff) !important;
            border-left-color: #0ea5e9 !important;
          }

          .job-drawer.selected-focus .appointment-hero-main {
            display: grid !important;
            grid-template-columns: minmax(0, 1fr) !important;
            gap: 4px !important;
          }

          .job-drawer.selected-focus .appointment-hero-main span {
            width: max-content !important;
            max-width: 100% !important;
            min-height: 22px !important;
            display: inline-flex !important;
          ...
          .job-drawer.selected-focus .appointment-hero.appointment-past .appointment-hero-main span,
          .job-drawer.selected-focus .appointment-hero.appointment-due .appointment-hero-main span {
            background: #ffedd5 !important;
            color: #9a3412 !important;
            border-color: rgba(249, 115, 22, 0.22) !important;
          }

          .job-drawer.selected-focus .appointment-hero-main strong {
            color: #0f172a !important;
            font-size: 25px !important;
            line-height: 1 !important;
            font-weight: 1000 !important;
          ...
          .job-drawer.selected-focus .appointment-hero-main small {
            color: #475569 !important;
            font-size: 12px !important;
            line-height: 1.25 !important;
            font-weight: 850 !important;
          ...
          .job-drawer.selected-focus .appointment-hero-contact {
            display: grid !important;
            grid-template-columns: minmax(0, 1fr) minmax(64px, 0.42fr) !important;
            gap: 7px !important;
          }
          ...
          .job-drawer.selected-focus .field-mission-primary-row,
          .job-drawer.selected-focus .field-mission-actions {
            display: none !important;
          }
