...
parser.add_argument("--days", type=int, default=None, help="Override Gmail lookback days")
args, _ = parser.parse_known_args()

LOOKBACK_DAYS = args.days if args.days is not None else (75 if args.initial else 7)
